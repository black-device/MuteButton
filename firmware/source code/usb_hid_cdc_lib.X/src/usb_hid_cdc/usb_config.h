...
#define HID_RPT01_SIZE          104//78//63
...
/* CDC */
#define CDC_COMM_INTF_ID        0x01//0x0
#define CDC_COMM_EP              2//1
#define CDC_COMM_IN_EP_SIZE      10

#define CDC_DATA_INTF_ID        0x02//0x01
#define CDC_DATA_EP             3//2
